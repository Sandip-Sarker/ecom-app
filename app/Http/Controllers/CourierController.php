...
class CourierController extends Controller
{
    ...
    public function update(Request $request, Courier $courier)
    {
        ...
        return redirect()->route('courier.index')->with('message', 'Courier info update successfully');
    }
    ...
    public function destroy(Courier $courier)
    {
        ...
        return redirect()->route('courier.index')->with('message', 'Courier info delete successfully');
    }
}
