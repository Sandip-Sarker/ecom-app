                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        @foreach(Cart::content() as $item)
                                            <li>
                                                <a href="{{route('cart.remove' ,$item->rowId)}}" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">{{$total = $sum}}</span>
                                        </div>
                                        <div class="button">
                        ...
                        <ul class="sub-category">
                            ...
                            <li>
                                ...
                                <ul class="inner-sub-category">
                                    ...
                                    <li>
                                        <a href="{{route('product-sub-category', $subCategory->id)}}">
                                            {{$subCategory->name}}
                                        </a>
                                    </li>
                                    @endforeach
