            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('category.index')}}" class="slide-item">Mange Category</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="maps1.html" class="slide-item">Add Product</a></li>
                        <li><a href="maps1.html" class="slide-item">Manage Product</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Manage Customer</a></li>
                    </ul>
                </li>
