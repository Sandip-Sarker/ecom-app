                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" name="name" id="productName" value="{{$product->name}}" placeholder="Enter Product name" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" name="code" id="productCode" value="{{$product->code}}"  placeholder="Enter Product Code" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" name="stock_amount" value="{{$product->stock_amount}}" id="stockAmount" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="meta_title" id="metaTitle" placeholder="Text Meta Title"> {{$product->meta_title}} </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="short_description" id="shortDescription" placeholder="Text short something here.."> {{$product->short_description}} </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="long_description" id="summernote" placeholder="Text Long something here.."> {{$product->long_description}} </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <label><input  name="status" id="status" {{$product->status == 1 ? 'checked' : ''}}  type="radio" checked value="1"> Published</label>
                                        <label><input  name="status" id="status" {{$product->status == 0 ? 'checked' : ''}} type="radio" value="0"> Unpublished</label>
                                    </div>
                                </div>
